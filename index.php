    ...
    <main>
        <section id="sectionMouv" style="height: 55vh;background-color: white;position: relative;z-index: 1;">
          <div id="test"  style="display: flex;flex-direction: column;align-items: center;">
            ...
            <span class="sousTitre">RIVA GIRARD - LA BOUTIQUE  <br> DE LUXE A PARIS</span>
        ...
        <section id="sectionImg" style="z-index: 2;position: relative;background-color: white">
          <div id="bg-img" style="background-color:black ;width:100%;z-index: 2;position: relative;height:100vh;background-size: cover;background-position: 100% 100%;"></div>
        ...
        <div style="position: fixed;top:28%;left:39.5%;z-index:0;text-align:center">
          ...
          <div id="prestige" style="display:grid;grid-template-columns: repeat(2, 1fr);grid-gap: 6vw 25vw ;width:100%;justify-items:center;margin:18vmin 0;">
...
tl2.to( "#bg-img",{ height:"auto",duration: 3});
...
tl3.to("#prestige",{margin:'auto',duration:3})*/
